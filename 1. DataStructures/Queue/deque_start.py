...
print('deque - создаем очередь')
deq = deque()  # создали пустую очередь
print(deq)

# очередь с набором элементов
print('очередь с набором элементов')
...
print('maxlen - максимальная длина очереди')
...
print('append, appendleft - добавить элемент в конец очереди, в начало')
...
print('pop, popleft - удаление и возрат последнего элемента очереди, первого элемента')
...
print('extend - позволяет добавить в очередь сразу несколько элементов')
...
print('insert - позволяет вставлять элемент в произвольную позицию')
...
print('remove - удаление элемента по значению, первый элемент который встретиться удовлетворяет значению')
...
print('clear - удаление всех элементов из очереди')
...
print('copy - создание копии очереди')
deq_9 = deque([1, 2, 3, 4, 5, 3, 3])
print('deq_9', id(deq_9))
deq_9_copy = deq_9.copy()
print('deq_9_copy', id(deq_9_copy))

# reverse - переворачивает очередь
print('reverse - переворачивает очередь')
deq_10 = deque([1, 2, 3, 4, 5, 3, 3])
print('deq_10', deq_10)
deq_10.reverse()
print('deq_10', deq_10)

# rotate - крутить на шаг n (+-сторона)
print('rotate - крутить на шаг n (+-сторона)')
deq_11 = deque([1, 2, 3, 4, 5, 3, 3])
print('deq_11', deq_11)
deq_11.rotate(2)
print('deq_11', deq_11)
deq_11.rotate(-4)
