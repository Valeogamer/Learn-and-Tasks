...
if __name__ == '__main__':
    ...
    OUT_DIM = 3  # кол - во выходов нейронов
    H_DIM = 10  # кол - во нейронов в hidden(скрытом) слое

    x = np.array([7.9, 3.1, 7.5, 1.8])  # Входные данные
    ...
    W1 = np.array([[0.33462099, 0.10068401, 0.20557238, -0.19043767, 0.40249301, -0.00925352, 0.00628916, 0.74784975,
                   ...
                   [-0.67791724, 0.07044558, -0.40981071, 0.62098450, -0.33009159, -0.47352435, 0.09687051, -0.68724299,
                    0.43823402, -0.26574543]])  # веса с обученной модели

    b1 = np.array([-0.34133575, -0.24401602, -0.06262318, -0.30410971, -0.37097632, 0.02670964, -0.51851308, 0.54665141,
    ...
    W2 = np.array([[0.41186367, 0.15406952, -0.47391773],
                   ...
                   [0.26099978, 0.12834471, 0.20866959]])  # Веса с обученной модели

    b2 = np.array([-0.16286677, 0.06680119, -0.03563594])


    # x = np.random.randn(INPUT_DIM)
    # W1 = np.random.randn(INPUT_DIM, H_DIM)  # строк на столбцов
